...
def smartshop_pipeline(
    raw_data_path: str = "s3://smartshop/raw/",
    features_path: str = "s3://smartshop/features/",
    llm_data_path: str = "s3://smartshop/llm_data/",
    embeddings_path: str = "s3://smartshop/features/review_embeddings/",
    metadata_path: str = "s3://smartshop/raw/metadata/",
    ...
    # Stage 1: Spark preprocessing (parallel jobs)
